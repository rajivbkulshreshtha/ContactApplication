package com.example.rajiv.contactapplication.provider;
...
public class ContactFetcher {
    ...
    private static ContactFetcher mInstance = null;

    public static ContactFetcher getInstance(Context c) {
        if (mInstance == null) {
            mInstance = new ContactFetcher(c);
        }
        return mInstance;
    }


    private ContactFetcher(Context c) {
        this.context = c;
    }
